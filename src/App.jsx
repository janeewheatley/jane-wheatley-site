      ...
      <Routes>
        <Route path="/" element={
          <div>
            ...
            <div className="flex justify-center items-center pt-20 px-4 sm:px-6 lg:px-8">
              <img
                src="images/headshot.jpeg"
                className="headshot w-60 h-60 sm:w-70 sm:h-70 md:w-72 md:h-72 lg:w-80 lg:h-80 object-cover rounded-full"
                alt="Jane Wheatley"
              />
            </div>
